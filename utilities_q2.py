...
Original file is located at
    https://colab.research.google.com/drive/1O57XVrsQRW-D2uPzRe-cCkx5VqiB3dSw
"""
...
def plot_displacements_bar(x, u, u_analytic=None):
    ...
    # Plot data
    if u_analytic != None:
        ax.plot(x.detach().numpy(), u_analytic(x.detach().numpy()),color='g', linewidth=2, label="u_analytic")
...
def plot_stiffness_bar(x, EA, EA_analytic=None):
    ...
    # Plot data
    ax.plot(x.detach().numpy(), EA.detach().numpy(),color='g', label="EA_pred")
    if EA_analytic != None:
